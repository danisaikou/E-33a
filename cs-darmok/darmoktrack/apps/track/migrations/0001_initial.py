# Generated by Django 4.1.1 on 2022-12-08 19:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_spent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='time', to='track.timeclock')),
            ],
            options={
                'ordering': ['due_date'],
            },
